...
public class WaterFungusConfiguration implements FeatureConfiguration {
    public static final Codec<WaterFungusConfiguration> CODEC = RecordCodecBuilder.create((instance) -> {
        ...
        }), BlockState.CODEC.fieldOf("stem").forGetter((configuration) -> {
        ...
        }), IntProvider.CODEC.fieldOf("stem_width").forGetter((configuration) -> {
            return configuration.stem_width;
    ...
    public final IntProvider stem_width;
    public final IntProvider cap_height;
    public final IntProvider cap_width;

    /**
     * @param ground optional blockstate to place underneath when grown
     ...
     * @param stem_width min and max width to construct the fungus stem
     ...
     */
    public WaterFungusConfiguration(@Nullable BlockState ground, BlockState stem, @Nullable BlockState spore,
                                    BlockState cap, @Nullable BlockState fruit, IntProvider stem_height,
                                    IntProvider stem_width, IntProvider cap_height, IntProvider cap_width) {
        this.ground = ground;
        this.stem = stem;
        this.spore = spore;
        this.cap = cap;
