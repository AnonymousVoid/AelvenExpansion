...
public class ModBoatModel extends ListModel<ModBoat> {
    ...
    public ModBoatModel(ModelPart pRoot, boolean pWithChest) {
     ...
     */
    public void setupAnim(@NotNull ModBoat pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
