...
public class IdolTableScreen extends AbstractContainerScreen<IdolTableMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(AelvenExpansion.MODID, "textures/gui/idol_table_gui.png");

    public IdolTableScreen(IdolTableMenu menu, Inventory inv, Component component) {
